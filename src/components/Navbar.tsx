...
export default function Navbar() {
  return (
    <header
      data-site-header
      className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm border-b border-slate-100 py-1.5"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex items-center justify-between gap-3 min-h-[66px]">
          <Logo variant="horizontal" priority className="min-w-0 max-w-[calc(100%-3rem)] sm:max-w-none" />
