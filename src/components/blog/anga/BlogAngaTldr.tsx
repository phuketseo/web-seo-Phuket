...
export function BlogAngaTldr({ title, items }: Props) {
  ...
  return (
    <section className="mb-10 rounded-2xl border border-violet-100/90 bg-gradient-to-br from-violet-50/80 via-white to-indigo-50/40 p-6 sm:p-7 shadow-sm ring-1 ring-violet-100/50">
      {title && (
